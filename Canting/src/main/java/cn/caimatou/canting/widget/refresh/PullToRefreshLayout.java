...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private void initView(Context context) {
        ...
        rotateAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
                context, R.anim.gl_reverse_anim);
        refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
                context, R.anim.gl_rotating);
        // 添加匀速转动动画
    ...
    private void initView() {
        // 初始化下拉布局
        pullView = refreshView.findViewById(R.id.ivPullIcon);
        refreshStateTextView = (TextView) refreshView.findViewById(R.id.tvRefreshState);
        refreshingView = refreshView.findViewById(R.id.ivRefreshingIcon);
        refreshStateImageView = refreshView.findViewById(R.id.ivRefreshState);
        // 初始化上拉布局
        pullUpView = loadmoreView.findViewById(R.id.ivPullupIcon);
        loadStateTextView = (TextView) loadmoreView.findViewById(R.id.tvLoadState);
        loadingView = loadmoreView.findViewById(R.id.ivLoadingIcon);
        loadStateImageView = loadmoreView.findViewById(R.id.ivLoadstate);
    }
