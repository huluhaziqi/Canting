 ...
 */
public class GLChoosePostAdapter extends BaseExpandableListAdapter {
    ...
    public GLChoosePostAdapter(Context context, ArrayList<Post> list, IGLOnListItemClickListener listener) {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (b) {
            ((ImageView) view.findViewById(R.id.choose_post_icon)).setImageDrawable(GLResourcesUtil.getDrawable(R.mipmap.icon_pwd_selected));
            ((ImageView) view.findViewById(R.id.choose_post_arrow)).setImageDrawable(GLResourcesUtil.getDrawable(R.mipmap.icon_expand_up));
        } else {
            ((ImageView) view.findViewById(R.id.choose_post_icon)).setImageDrawable(GLResourcesUtil.getDrawable(R.mipmap.icon_pwd_unselect));
            ((ImageView) view.findViewById(R.id.choose_post_arrow)).setImageDrawable(GLResourcesUtil.getDrawable(R.mipmap.icon_expand_down));
        }
        return view;
    }
